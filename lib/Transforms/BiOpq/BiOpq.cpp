...
namespace {
  struct BogusControlFlow : public FunctionPass {
    ...
    virtual bool runOnFunction(Function &F){
	  ...
	  attrGV2->setUnnamedAddr(llvm::GlobalValue::UnnamedAddr(2));
	  attrGV3->setUnnamedAddr(llvm::GlobalValue::UnnamedAddr(2));
	...
	/*
	    SmallVector<AttributeSet, 4> attrVec;
	    AttributeSet attrSet;
	    AttrBuilder attrBuilder;
	    attrBuilder.addAttribute(Attribute::NoUnwind);
	    attrBuilder.addAttribute(Attribute::UWTable);
	    attrSet = AttributeSet::get(context, ~0U, attrBuilder);
 	    attrVec.push_back(attrSet);
	    AttributeSet fprintfAttr = AttributeSet::get(context, attrVec);
	    ((Function *) fprintfFunc)->setAttributes(fprintfAttr);
		*/
	  }
	...
	bool InsertFproOpq(Module &M, Instruction* inst, Value* arg){
		...
		GetElementPtrInst* attrEPI2 = GetElementPtrInst::CreateInBounds(ch2AT, attrGV2, ar0I0,"", inst);
		GetElementPtrInst* attrEPI3 = GetElementPtrInst::CreateInBounds(ch3AT, attrGV3, ar0I0,"", inst);
