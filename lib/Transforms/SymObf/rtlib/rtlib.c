...
int64_t** MultIntMatrix(int64_t** mat1, int64_t** mat2, int64_t m1Height, int64_t m1Width, int64_t m2Height, int64_t m2Width){
...
double** MultFpMatrix(double** mat1, double** mat2, int64_t m1Height, int64_t m1Width, int64_t m2Height, int64_t m2Width){
  printf("Entering MatrixMult: perform maltiplication...\n");
